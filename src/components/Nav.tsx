...
function Nav() {
  return (
    <nav className="px-4 py-2.5 w-full top-0 left-0 border-b border-gray-300 shadow-md">
      <div className="container mx-auto flex justify-between">
        <div>
          <div className="flex flex-wrap items-center">
            ...
            <div className="hidden items-center md:flex md:w-auto">
              <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                <li>
                  <Link
                    to="/"
                    className="block py-2 pr-4 pl-3 text-black hover:border-b-2 border-[#C03838] bg-transparent md:p-0"
                  >
                    Home
                  </Link>
                </li>
